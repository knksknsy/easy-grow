...
"<p>Unfortunately the full documentation of this project does not fit in here due to the small flash size of the ESP-8266.</p>"
"<p>The full documentation can be found in our git repository: <a target='_blank' "
"href='https://gitlab.mi.hdm-stuttgart.de/embedded/ss19/easy-grow/blob/master/readme.md'>https://gitlab.mi.hdm-stuttgart.de/embedded/ss19/easy-grow/blob/master/readme.md</a> </p>"
"</div></body></html>"
